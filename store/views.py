...
# ==============================================================================
# 1. MAIN CUSTOMER VIEWS (Homepage, Product Details)
# ==============================================================================
...
def store_home(request):
    ...
    # === DASHBOARD IS THE BOSS NOW ===
    # Jo dashboard mein select hoga, wahi chalega. Dates ignore hongi.
    ...
    # Fetch Music URL Safely from Database bypassing ORM blocks
    music_url_to_play = ""
    try:
        from django.db import connection
    ...
    return render(request, 'home.html', {
        ...
        'festival_music_url': music_url_to_play, # Sent to frontend
...
def custom_dashboard(request):
    ...
    if request.method == 'POST':
        ...
        # Save Music using Raw SQL so it bypasses ORM blocks completely
        try:
            with connection.cursor() as cursor:
    ...
    # Fetch current music url to display in dashboard form
    current_music_url = ""
    try:
        with connection.cursor() as cursor:
            cursor.execute("SELECT festival_music_url FROM store_storesetting WHERE id = %s", [setting.id])
    ...
    return render(request, 'dashboard.html', {
        ...
        'current_music_url': current_music_url # So the input box stays filled
    })
...
def checkout_view(request):
    ...
    if request.method == 'POST':
        ...
        order = Order.objects.create(
            ...
            phone=phone, address=full_address, city=city, pincode=pincode,
...
def payment_page_view(request):
    ...
    if not order_id: return redirect('home')
...
# ==============================================================================
# 4. CUSTOMER AUTHENTICATION (Login, Register, Forgot Password)
# ==============================================================================
...
# ==============================================================================
# 5. SELLER ADMIN DASHBOARD (Manage Products, Music, Themes)
# ==============================================================================
...
def custom_dashboard(request):
    ...
    if request.method == 'POST':
        ...
        # 🎵 FIXED MUSIC SAVING BUG HERE
        music_input = request.POST.get('music_url')
        if music_input:
            setting.festival_music_url = music_input
